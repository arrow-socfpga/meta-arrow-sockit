DESCRIPTION = "Arrow SoCKit GSRD web content"
...
SRC_URI += "file://sockit_front.jpg"
SRC_URI += "file://sockit_back.jpg"
...
do_install() {
        ...
        install -m 0755 sockit_front.jpg ${D}/www/pages/
        install -m 0755 sockit_back.jpg ${D}/www/pages/
